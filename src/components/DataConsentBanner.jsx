      ...
      {isVisible && (
        ...
        >
          <div className="consent-content">
            ...
            <p>
              <strong>Data Collection Notice:</strong> We collect anonymous
              gameplay data (moves, times, results) to improve our Machine
              Learning models. No personal identifiers are logged.
            </p>
          </div>
          <div className="consent-actions">
            ...
            <button
              className="btn-close-consent"
              onClick={() => {
                localStorage.setItem("dualmind_data_consent", "false");
                setIsVisible(false);
              }}
              aria-label="Close"
            >
