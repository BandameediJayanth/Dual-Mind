        ...
        <div className="cognitive-card-wrapper">
            <div className="cognitive-card" ref={cardRef}>
                <div className="card-header">
                    ...
                    <div className="tier-badge" style={{ backgroundColor: `${tierColor}20`, color: tierColor, border: `1px solid ${tierColor}50` }}>
                ...
                <div className="radar-container">
                    <svg viewBox="0 0 300 300" className="radar-chart">
                        ...
                        {dataPoints.map((_, i) => {
                            ...
                            return <line key={i} x1="150" y1="150" x2={x} y2={y} className="radar-axis" />;
                        })}
                        ...
                        {getLabelPositions().map((pos, i) => (
                            <g key={i} transform={`translate(${pos.x}, ${pos.y})`}>
                                <text textAnchor="middle" className="radar-label" dy="-5">{pos.label}</text>
                                <text textAnchor="middle" className="radar-value" dy="10">{pos.value}</text>
                            </g>
                        ))}
                    </svg>
                </div>
